...
# ---------------------------------------------------------------------------
# Ensure the rl-environment code is importable when running from /app or
# from the repo root.
# ---------------------------------------------------------------------------
_SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
_REPO_ROOT = os.path.dirname(_SCRIPT_DIR)
_RL_ENV_DIR = os.path.join(_REPO_ROOT, "rl-environment")

for _candidate in (_RL_ENV_DIR, _REPO_ROOT):
    if _candidate not in sys.path:
        sys.path.insert(0, _candidate)

# If running inside Docker /app, the models package is right there.
if "/app" not in sys.path and os.path.isdir("/app/models"):
