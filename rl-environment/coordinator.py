    ...
    async def save_generation_models(self, generation: int, fitness_scores: List[float]):
        ...
        for i, idx in enumerate(top_indices):
            ...
            cfg['rare_state_tracking'] = {
                ...
                "draft_decisions_total": int(behavior_snapshot.get("draft_decisions_total", 0) or 0),
                "draft_decisions_low_hand_ev": int(behavior_snapshot.get("draft_decisions_low_hand_ev", 0) or 0),
                "hate_draft_picks": int(behavior_snapshot.get("hate_draft_picks", 0) or 0),
                "hate_draft_picks_low_hand_ev": int(behavior_snapshot.get("hate_draft_picks_low_hand_ev", 0) or 0),
                "hate_draft_rate": float(behavior_snapshot.get("hate_draft_rate", 0.0) or 0.0),
                "hate_draft_rate_low_hand_ev": float(behavior_snapshot.get("hate_draft_rate_low_hand_ev", 0.0) or 0.0),
                "hate_draft_rate_vs_vp_corr": float(generation_metrics.get("hate_draft_rate_vs_vp_corr", 0.0) or 0.0),
                "hate_draft_rate_vs_rank_corr": float(generation_metrics.get("hate_draft_rate_vs_rank_corr", 0.0) or 0.0),
                "hate_draft_rate_vs_win_corr": float(generation_metrics.get("hate_draft_rate_vs_win_corr", 0.0) or 0.0),
                "hate_draft_corr_sample_count": int(generation_metrics.get("hate_draft_corr_sample_count", 0) or 0),
